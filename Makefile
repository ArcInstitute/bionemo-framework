...
NUMPY_VERSION ?= $(LAMBDA_NUMPY_VERSION)
MAX_JOBS ?= $(LAMBDA_MAX_JOBS)
TE_MAX_JOBS ?= $(LAMBDA_TE_MAX_JOBS)
CAUSAL_CONV1D_VERSION ?= $(LAMBDA_CAUSAL_CONV1D_VERSION)
TRANSFORMER_ENGINE_VERSION ?= $(LAMBDA_TRANSFORMER_ENGINE_VERSION)
MAMBA_SSM_VERSION ?= $(LAMBDA_MAMBA_SSM_VERSION)
NEMO_TOOLKIT_VERSION ?= $(LAMBDA_NEMO_TOOLKIT_VERSION)
else
